  ...
  },
  {
    ...
    signs: [
      ...
      },
      {
        ...
        video: "https://youtu.be/cm5FDh8O_VI",
        difficulty: "Medium",
      },
      {
        letter: "9",
        description: "Thumb and index touch",
        video: "https://youtu.be/pWbBIelTK7s",
        difficulty: "Medium",
      },
    ],
  },
...
export function SignLanguageViewer({
  ...
  const renderCategoryList = () => (
    <div className="space-y-6">
      ...
      <Card className="text-gray-700 bg-gradient-to-r from-blue-50 to-purple-50">
        <CardHeader>
